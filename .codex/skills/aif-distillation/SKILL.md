...
1. Prepare sources.
   ...
   - For large folders or PDFs, use `.codex/skills/aif-distillation/scripts/material-prep.py` to extract and chunk material, then clean temporary extraction artifacts with the helper after the skill is generated.
